...
def run_eval_hpsv2(args):
    ...
    print("HPSV2 Score:", np.mean(hpsv2_scores))

    # append hpsv2 score to the end of the file
    with open(args.image_path + "/score.txt", "a") as f:
        f.write(f"HPSV2 Score: {np.mean(hpsv2_scores)}\n")
